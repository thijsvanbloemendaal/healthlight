import urllib.request, json, threading, time , datetime, RPi.GPIO as GPIO
   ...
   def run(self):
      ...
      while True:
        if datetime.datetime.now().time() > self.lightState.Switch.StartTime and datetime.datetime.now().time() < self.lightState.Switch.EndTime :
            ...
            if self.lightState.LightRed.On:
                if self.lightState.LightRed.Pattern == "solid":
            ...
            if self.lightState.LightOrange.On:
                if self.lightState.LightOrange.Pattern == "solid":
            ...
            if self.lightState.LightGreen.On:
                if self.lightState.LightGreen.Pattern == "solid":
